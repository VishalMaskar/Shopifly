...
import com.vishal.com.shopify.Model.Products;
...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    private TextView productName,productDescription,produtcPrice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       addToCartButton = findViewById(R.id.pd_add_to_cart_button);
        ...
        produtcPrice = findViewById(R.id.product_price_details);
        ...
        addToCartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(state.equals("Order Placed")|| state.equals("Order Shipped")){
                    ...
                    Toast.makeText(getBaseContext(),"You can purchase more items, once your order is shipped or confirmed.",Toast.LENGTH_LONG).show();
    ...
    private void addingToCartList() {
        ...
        cartMap.put("price",produtcPrice.getText().toString());
        ...
        productsRef.child(productID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()){
                    ...
                    produtcPrice.setText(products.getPrice());
