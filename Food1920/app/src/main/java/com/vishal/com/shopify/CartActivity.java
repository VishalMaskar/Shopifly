...
import com.vishal.com.shopify.ViewHolder.CartViewHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getBaseContext(),ConfirmFinalOrderActivity.class);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()){
                    ...
                    if(shippingState.equals("shipped")){
                        ...
                        Toast.makeText(getBaseContext(),"You can purchase more items, once you received your first final order",Toast.LENGTH_SHORT).show();
